...
public class StepSetPulse extends StepCommon {
	...
	final Runnable op1 = ()->operation(TAG0,args[0],4);
	final Runnable op2 = ()->operation(TAG1,args[1],6);
	final Runnable op3 = ()->operation(TAG2,args[2],5);
	final Runnable op4 = ()->operation(TAG3,args[3],7);	
	final Runnable op5 = ()->{ show_mesg(init_text); jump(); };
